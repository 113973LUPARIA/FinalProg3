...
namespace ApiFinalMarzo.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(IModeloService modeloService)
        {
        ...
        //{
        //    var usuario = await _modeloService.Usuarios.Include(x => x.Rol).FirstOrDefaultAsync(x => x.Email == login.Email && x.Password == login.Password);
